<template>
    <div>
        ...
        <table>
            ...
            <tr v-for="student in students" v-bind:key="student._id" v-bind:style="student.name.toUpperCase().indexOf(filter_name.toUpperCase())>-1 && filter_name.length >0 ? 'background-color: dodgerblue'  : 'thirdNone'">
                ...
                <td ><a class="btn" v-on:click="deleteStud(student._id)">Delete student</a></td>
